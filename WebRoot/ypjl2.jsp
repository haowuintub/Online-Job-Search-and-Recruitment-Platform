...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  ...
  <%
  String sql="";
  sql="select * from ypjl where gs='"+request.getSession().getAttribute("gongsi")+"'";
...
%>
  <tr>
    ...
    <td><%=xh %></td>
    <td><a href="biyesheng_detail_byxh.jsp?xh=<%=xh%>"><%=xm %></a>
    </td><td><%=gwmc %></td><td><%=gs %></td><td width="138" align="center"><%=addtime %></td>
