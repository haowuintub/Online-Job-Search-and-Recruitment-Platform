...
String sql="update biyesheng set xuehao='"+xuehao+"',xingming='"+xingming+"',xingbie='"+xingbie+"',minzu='"+minzu+"',chushengnianyue='"+chushengnianyue+"',jiatingzhuzhi='"+jiatingzhuzhi+"',ruxiaoshijian='"+ruxiaoshijian+"',xibu='"+xibu+"',techang='"+techang+"',zhuanye='"+zhuanye+"',mima='"+mima+"',jianli='"+jianli+"' where id= "+id;
connDbBean.executeUpdate(sql);
out.print("<script>alert('ÐÞ¸Ä³É¹¦!!');location.href='biyesheng_list.jsp';</script>");
%>
  </body>
</html>
