...
function check()
{
  ...
  <form name="form1" id="form1" method="post" action="gongsi_updt_post2.jsp">
  公司修改个人资料:
  <br>
  <br>
  <%
  String sql="select * from gongsi where yonghuming='"+request.getSession().getAttribute("username")+"'";
