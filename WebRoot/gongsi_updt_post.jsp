...
String sql="update gongsi set yonghuming='"+yonghuming+"',mima='"+mima+"',gongsimingcheng='"+gongsimingcheng+"',zhucezijin='"+zhucezijin+"',dianhua='"+dianhua+"',dizhi='"+dizhi+"',guimo='"+guimo+"',xingye='"+xingye+"',jianjie='"+jianjie+"' where id= "+id;
connDbBean.executeUpdate(sql);
out.print("<script>alert('ÐÞ¸Ä³É¹¦!!');location.href='gongsi_list.jsp';</script>");
%>
  </body>
</html>
