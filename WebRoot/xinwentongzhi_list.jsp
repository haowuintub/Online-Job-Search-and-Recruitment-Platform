...
%>
  <tr>
    ...
    <td><%=addtime %></td>
    <td align="center"><a href="xinwentongzhi_updt.jsp?id=<%=id%>">修改</a>  <a href="del.jsp?id=<%=id %>&tablename=xinwentongzhi&lb=<%=new String(request.getParameter("lb").getBytes("8859_1")) %>" onClick="confirm('真的要删除？')">删除</a></td>
  </tr>
  	<%
  }
   %>
